...
folder are mapped to the application's root namespace, 'Mvvm.app'. This is set in
`"app.json"`:
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'Mvvm.app' in the same way
as `"Mvvm.app/sass/src"`.
